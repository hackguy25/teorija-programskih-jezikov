...
let rec step = function
  ...
  (*| S.Pair (v1, v2) when is_value v2 && is_value v1 -> failwith "Expected a non-terminal expression"
  ...
  (*| S.Cons (v1, _) when is_value v1 -> failwith "Expected a non-terminal expression"
